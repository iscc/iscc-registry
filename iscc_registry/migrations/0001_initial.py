...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "simhash",
                    models.CharField(
                        help_text="Simhash decoded ISCC-ID", max_length=32, verbose_name="simhash"
                    ),
                ),
                (
                    "frozen",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time",
                    models.DateTimeField(
                        help_text="Block time of declaration", verbose_name="time"
                    ),
                ),
                (
                    "tx_idx",
                ...
                (
                    "meta_url",
                    models.URLField(blank=True, default=None, null=True, verbose_name="meta_url"),
                ),
                (
                    "metadata",
                    models.JSONField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=("chain", "tx_hash"), name="unique_tx"),
        ),
    ]
