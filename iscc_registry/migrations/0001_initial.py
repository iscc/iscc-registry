# Generated by Django 4.0.4 on 2022-05-02 08:59
            ...
            fields=[
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(0, "Private"), (1, "Bitcoin"), (2, "Ethereum"), (3, "Polygon")],
                ...
                (
                    "name",
                    models.SlugField(
                        help_text="Name of blockchain network", max_length=32, verbose_name="name"
                    ),
                ),
                (
                    "url_template",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether the ISCC-ID is active",
                        verbose_name="active",
                    ),
                ),
                (
                ...
                (
                    "iscc_code",
                    models.CharField(
                        help_text="An ISCC-CODE", max_length=96, verbose_name="ISCC-CODE"
                    ),
                ),
                (
                    "meta_url",
                ...
                (
                    "timestamp",
                    models.DateTimeField(
                        help_text="Block time of declaration", verbose_name="timestamp"
                    ),
                ),
                (
                    "block_height",
                ...
                (
                    "block_hash",
                    models.CharField(
                        help_text="Hash of block", max_length=255, verbose_name="block hash"
                    ),
                ),
                (
                    "tx_idx",
                ...
                (
                    "simhash",
                    models.CharField(
                        help_text="Simhash of ISCC-ID", max_length=32, verbose_name="simhash"
                    ),
                ),
                (
                    "metadata",
